...
print(random.random()) # gives any random floating point number.
print(random.randint(1,10)) # enumerates between given range of integer numbers.
print(random.choice([2,4,6,8,10])) # Takes an array/sequence of elements and randomly picks an element from array.
print(random.choice(["An","Arrray","of","Strings."])) # Takes an array/sequence of elements and randomly picks an element from array.

print(random.choice("abcdefghijklmnopqrstuvwxyz0123456789")) # picks one element ; randomly from sequence
