...
# print(cloud.tags["PYTHON"])  # KeyError

# This error occured because we could directly access attribute "tags".
# To make this attribute private (by convention), use prefix __ (double underscore.) for attri."tag"

# NOTE : So to make attribute/even a method, as private prefix them with __ (double underscore.)
...
# basically returns our (private member) dictionary 'tags'.
